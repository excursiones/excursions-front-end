...
class AdminHome extends React.Component {
  ...
  componentDidMount() {
    Http.post(
      "",
      {
        query: "query { totalDebts { Cuentas_por_pagar Intereses_por_pagar }}"
      },
      false,
      true
    ).then(response => {
      ...
      this.setState({
        Cuentas_por_pagar: debts.Cuentas_por_pagar,
        Intereses_por_pagar: debts.Intereses_por_pagar
      });
    });
  }
            ...
            <GridItem xs={12} sm={6} md={3}>
              <Card>
                <CardHeader color="success" stats icon>
                  ...
                  <h2 className={classes.cardSubTitle}>
                    $ {this.state.Intereses_por_pagar}
                  </h2>
                </CardHeader>
                <CardFooter stats>
                  <div className={classes.stats}>
